...
class TestKauppa(unittest.TestCase):
    ...
    def test_tilisiirto_kutsutaan_oikeilla_arvoilla_kaksi_eri_tuotetta(self):
    ...
    def test_tilisiirto_kutsutaan_oikeilla_arvoilla_kaksi_samaa_tuotetta(self):
    ...
    def test_tilisiirto_kutsutaan_oikeilla_arvoilla_kaksi_eri_tuotetta_toinen_loppu(self):
    ...
    def test_jokaiselle_tapahtumalle_uusi_viitenumero(self):
